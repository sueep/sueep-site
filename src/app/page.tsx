          ...
          <div className="mt-12 grid md:grid-cols-4 gap-8">
            {[
              ...
              <div key={person.name} className="text-center">
                <img src={person.img} alt={person.name} className="mx-auto w-full h-96 object-cover object-top grayscale hover:grayscale-0 transition border border-gray-200" />
